...
<!-- SITE TITLE -->
<title> <?=$db->ayarlar("value" , "siteismi");?> l Hakkımızda </title>
...
<div class="page-title page-title-about bg-pattern" data-bgcolor="014087">
    <div class="page-title-overlay">
        <div class="container">
            ...
            <h1>HAKKIMIZDA</h1>
<p> Kliniğimiz 2008 yılında ağız diş sağlığında uzman kadrosuyla Adana'nın merkezi noktalarından Reşatbey bölgesinde hizmet vermeye başlamıştır.</p>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 history-text">
                <h3>Hakkımızda</h3>
                <p style="margin-left:-25px;"><?=$db->ayarlar("value" , "hakkimizda");?></p>
             </div>
