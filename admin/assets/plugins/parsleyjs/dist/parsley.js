...
window.ParsleyConfig.i18n.en = jQuery.extend(window.ParsleyConfig.i18n.en || {}, {
  defaultMessage: "Geçersiz değer yazdınız.",
  type: {
    ...
    digits:       "Basamaklı bir sayı olmalıdır.",
    alphanum:     "Alfanümerik olmalıdır."
  },
  notblank:       "Boş olmamalıdır.",
  required:       "Zorunlu alan",
  pattern:        "Geçersiz değer yazdınız.",
  min:            "%s den daha yüksek veya eşit olmalıdır.",
  max:            "%s den daha düşük veya eşit olmalıdır.",
  range:          "%s ile %s arasında olmalıdır.",
  minlength:      "Çok kısa %s karakter veya daha fazla olmalıdır.",
  maxlength:      "Çok uzun %s karakter veya daha az olmalıdır.",
  length:         "Uzunluk geçersiz. %s ile %s karakter aralığında olması gerekir.",
  mincheck:       "En az %s opsiyonu seçmelisiniz.",
  maxcheck:       "En fazla %s opsiyonu seçmelisiniz.",
  check:          "%s ile %s arasında opsiyonu seçmelisiniz.",
